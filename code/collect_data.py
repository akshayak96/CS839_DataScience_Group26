...
def create_IJ(files, size):
    ...
    testSet = files[size:316:1]
    print(len(testSet))
    i = 0

    for filename in os.listdir("/Users/elenamilkai/Desktop/project/data/trainY/"):
        if not filename.startswith('.'):

            src = "/Users/elenamilkai/Desktop/project/data/original/" + filename
    ...
    for filename in os.listdir("/Users/elenamilkai/Desktop/project/data/testY/"):
        if not filename.startswith('.'):
            src = "/Users/elenamilkai/Desktop/project/data/original/" + filename
            dst = '/Users/elenamilkai/Desktop/project/data/test/' + filename
            copyfile(src, dst)
